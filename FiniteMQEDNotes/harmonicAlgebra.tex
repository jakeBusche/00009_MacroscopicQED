...
We would like the notation for the harmonics to be as succinct as possible. Therefore, for shorthand, we can define the transverse vector harmonics more compactly as
\begin{equation}
\begin{split}
