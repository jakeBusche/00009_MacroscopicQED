...
\begin{equation}
\begin{split}
% \mathcal{L}_\mathrm{int} &= -\left[-e\eta\nabla\cdot\left\{\Theta(\mathbf{r}\in\mathbb{V})\mathbf{Q}(\mathbf{r},t)\right\} + \rho_f(\mathbf{r},t)\right]\left[\Phi(\mathbf{r},t) + \Phi_f(\mathbf{r},t)\right]\\
% &\qquad + \frac{1}{c}\left[e\eta\Theta(\mathbf{r}\in\mathbb{V})\dot{\mathbf{Q}}(\mathbf{r},t) + \mathbf{J}_f(\mathbf{r},t)\right]\cdot\left[\mathbf{A}(\mathbf{r},t) + \mathbf{A}_f(\mathbf{r},t)\right]\\
...
% &= -\int\frac{1}{|\mathbf{r} - \mathbf{r}'|}\left(-e\eta\delta(r' - a)\hat{\mathbf{r}}'\cdot\sum_{\bm{\beta}n}\mathcal{B}_{\bm{\beta}n}(t)\mathbf{X}_{\bm{\beta}}(\mathbf{r},k_{\bm{\beta}n})\right.\\
...
% &\qquad\left. - \int_{r<a}\Omega^2\sum_{\bm{\beta}n}\mathcal{B}_{\bm{\beta}n}(t)\mathbf{X}_{\bm{\beta}}(\mathbf{r},k_{\bm{\beta} n})\cdot\sum_{\bm{\beta}'n'}\mathcal{B}_{\bm{\beta}'n'}(t)\mathbf{X}_{\bm{\beta}'}(\mathbf{r},k_{\bm{\beta}'n'})\;\mathrm{d}^3\mathbf{r}\right)\\
% &= \frac{\mu}{2}\left(\sum_{\bm{\beta}\bm{\beta}'nn'}\left[\dot{\mathcal{B}}_{\bm{\beta}n}(t)\dot{\mathcal{B}}_{\bm{\beta}'n'}(t) - \Omega^2\mathcal{B}_{\bm{\beta}n}(t)\mathcal{B}_{\bm{\beta}'n'}(t)\right]2\pi a^3(1 - \delta_{p1}\delta_{m0})\delta_{\bm{\beta}\bm{\beta}'}\delta_{nn'}\right.\\
...
% &= \pi a^3\mu\sum_{\bm{\beta}n}(1 - \delta_{p1}\delta_{m0})\left[ \vphantom{\frac{\ell(\ell + 1)}{(k_{\bm{\beta}n}a)^2}} (\delta_{TM} + \delta_{TE})j_{\ell + 1}^2(z_{\ell n})\left(\dot{\mathcal{B}}_{\bm{\beta}n}^2(t) - \Omega^2\mathcal{B}_{\bm{\beta}n}^2(t)\right)\right.\\
% &\qquad\left. + \delta_{TL}j_\ell^2(w_{\ell n})\left(1 - \frac{\ell(\ell + 1)}{w_{\ell n}^2}\right)\left(\dot{\mathcal{B}}_{\bm{\beta}n}^2(t) - \Omega^2\mathcal{B}_{\bm{\beta}n}^2(t)\right)\right]\\
...
\\
% &= e^2\eta^2\sum_{p\ell nm}\sum_{p'\ell'm'n'}16\pi^2\mathcal{B}_{Lp\ell mn}(t)\mathcal{B}_{Lp'\ell'm'n'}(t)\\
...
% &= e^2\eta^2\sum_{p\ell m n}\sum_{p'\ell'm'n'}16\pi^2\mathcal{B}_{Lp\ell mn}(t)\mathcal{B}_{Lp'\ell'm'n'}(t)\\
% &\qquad\times \left[2\pi a^3j_\ell^2(w_{\ell n})\left(1 - \frac{\ell(\ell + 1)}{w_{\ell n}^2}\right)\delta_{pp'}\delta_{\ell\ell'}\delta_{mm'}\delta_{nn'} - 4\pi a^3\frac{j_{\ell - 1}(w_{\ell n})j_{\ell + 1}(w_{\ell n'})}{2\ell + 1}\delta_{pp'}\delta_{\ell\ell'}\delta_{mm'}\right.\\
% &\qquad - 4\pi a^3\frac{j_{\ell - 1}(w_{\ell n'})j_{\ell + 1}(w_{\ell n})}{2\ell + 1}\delta_{pp'}\delta_{\ell\ell'}\delta_{mm'}\\
...
% &= 8\pi\sum_{p\ell m}4\pi^2e^2\eta^2\mathcal{B}_{Lp\ell mn}(t)\mathcal{B}_{Lp\ell mn'}(t)\left[a^3j_\ell^2(w_{\ell n})\left(1 - \frac{\ell(\ell + 1)}{w_{\ell n}^2}\right)\delta_{nn'} - \frac{2}{2\ell + 1}a^3j_{\ell - 1}(w_{\ell n})j_{\ell + 1}(w_{\ell n'})\right.\\
% &\left.\qquad - \frac{2}{2\ell + 1}a^3j_{\ell - 1}(w_{\ell n'})j_{\ell + 1}(w_{\ell n}) + \frac{2}{(2\ell + 1)^2}a^3\left[(\ell + 1)j_{\ell + 1}(w_{\ell n})j_{\ell + 1}(w_{\ell n'}) + \ell j_{\ell - 1}(w_{\ell n})j_{\ell - 1}(w_{\ell n'})\right]\right]\\
% &= 8\pi\sum_{p\ell m}4\pi^2e^2\eta^2\mathcal{B}_{Lp\ell mn}(t)\mathcal{B}_{Lp\ell mn'}(t)\left[a^3j_\ell^2(w_{\ell n})\left(1 - \frac{\ell(\ell + 1)}{w_{\ell n}^2}\right)\delta_{nn'}\right.\\
% &\qquad - \frac{2}{2\ell + 1}\frac{\ell}{\ell + 1}a^3j_{\ell - 1}(w_{\ell n})j_{\ell - 1}(w_{\ell n'}) - \frac{2}{2\ell + 1}\frac{\ell}{\ell + 1}a^3j_{\ell - 1}(w_{\ell n'})j_{\ell - 1}(w_{\ell n})\\
% &\left.\qquad + \frac{2}{(2\ell + 1)^2}a^3\left(\frac{\ell^2}{\ell + 1}j_{\ell - 1}(w_{\ell n})j_{\ell - 1}(w_{\ell n}) + \ell j_{\ell - 1}(w_{\ell n})j_{\ell - 1}(w_{\ell n'})\right)\right]\\
% &= 8\pi\sum_{p\ell m}4\pi^2e^2\eta^2a^3\mathcal{B}_{Lp\ell mn}(t)\mathcal{B}_{Lp\ell mn'}(t)\left[j_\ell^2(w_{\ell n})\left(1 - \frac{\ell(\ell + 1)}{w_{\ell n}^2}\right)\delta_{nn'}\right.\\
% &\qquad\left. + \frac{2}{2\ell + 1}\left(-\frac{2\ell}{\ell + 1} + \frac{\ell^2}{(2\ell + 1)(\ell + 1)} + \frac{\ell}{2\ell + 1}\right) j_{\ell - 1}(w_{\ell n})j_{\ell - 1}(w_{\ell n'})\right]\\
% &= 8\pi\sum_{p\ell m}4\pi^2e^2\eta^2a^3\mathcal{B}_{Lp\ell mn}(t)\mathcal{B}_{Lp\ell mn'}(t)\left[j_\ell^2(w_{\ell n})\left(1 - \frac{\ell(\ell + 1)}{w_{\ell n}^2}\right)\delta_{nn'}\right.\\
% &\qquad\left. - \frac{2\ell}{(2\ell + 1)(\ell+1)}j_{\ell - 1}(w_{\ell n})j_{\ell - 1}(w_{\ell n'})\right]\\
&
...
\begin{split}
g_{\bm{\beta}nn'}^{(1)} 
% &= -\delta_{TL}4\pi^2e^2\eta^2a^3\left[j_\ell^2(w_{\ell n})\left(1 - \frac{\ell(\ell + 1)}{w_{\ell n}^2}\right)\delta_{nn'} - \frac{2\ell}{(2\ell + 1)(\ell+1)}j_{\ell - 1}(w_{\ell n})j_{\ell - 1}(w_{\ell n'})\right]\\
...
% &= - \sum_{\bm{\beta}}\sum_{nn'}g_{\bm{\beta}nn'}^{(1)}\mathcal{B}_{\bm{\beta}n}(t)\mathcal{B}_{\bm{\beta}n'}(t)\\
...
% &= - \sum_{\bm{\beta}}\sum_{nn'}g_{\bm{\beta}nn'}^{(1)}\mathcal{B}_{\bm{\beta}n}(t)\mathcal{B}_{\bm{\beta}n'}(t) + \frac{1}{8\pi}\sum_{\bm{\alpha}}\int_0^\infty\frac{e^2\omega^3}{c^4}c\left[\frac{2\pi^2}{k^2c^2}\dot{\mathcal{A}}_{\bm{\alpha}}^2(\omega,t) - 2\pi^2\mathcal{A}_{\bm{\alpha}}^2(\omega,t)\right]\;\mathrm{d}\omega\\
% &= - \sum_{\bm{\beta}}\sum_{nn'}g_{\bm{\beta}nn'}^{(1)}\mathcal{B}_{\bm{\beta}n}(t)\mathcal{B}_{\bm{\beta}n'}(t) + \sum_{\bm{\alpha}}\int_0^\infty\frac{\pi}{4}\frac{e^2\omega^3}{c^3}\left[\frac{1}{k^2c^2}\dot{\mathcal{A}}_{\bm{\alpha}}^2(\omega,t) - \mathcal{A}_{\bm{\alpha}}^2(\omega,t)\right]\;\mathrm{d}\omega\\
...
% = -e\eta\int_{r<a}\sum_{\bm{\beta}n}\mathcal{B}_{\bm{\beta}n}(t)\mathbf{X}_{\bm{\beta}}(\mathbf{r},k_{\bm{\beta}n})\cdot e\eta\sum_{p'\ell'm'n'}\frac{4\pi}{\sqrt{2\ell' + 1}}\mathcal{B}_{Lp'\ell'm'n'}(t)\\
...
% &\qquad\left. + \delta_{TL}\delta_{T'E}\sqrt{\ell(\ell+1)}\frac{a^2c}{w_{\ell n}\omega}j_\ell(w_{\ell n})j_\ell\left(\frac{\omega a}{c}\right)\right]\mathrm{d}\omega\\
% &
...
\begin{split}
g_{\bm{\beta}nn'}^{(2)} 
% &= \delta_{TL}16\pi^2e^2\eta^2\left[R_{T\ell}^\ll\left(\frac{w_{\ell n}}{a},\frac{w_{\ell n'}}{a};0,a\right) - \frac{a^3}{2\ell + 1}j_{\ell + 1}(w_{\ell n})j_{\ell - 1}(w_{\ell n'})\right]\\
% &= \delta_{TL}16\pi^2e^2\eta^2\left[R_{L\ell}^\ll\left(\frac{w_{\ell n}}{a},\frac{w_{\ell n'}}{a};0,a\right) - \frac{\ell(\ell + 1)}{2\ell + 1}\frac{a^3}{w_{\ell n}w_{\ell n'}}j_\ell(w_{\ell n})j_\ell(w_{\ell n'})\right]\\
...
\begin{split}
L &= 
% L_f + L_\mathrm{bind} + \sum_{\bm{\beta}n}\frac{m_{\bm{\beta}n}}{2}\left(\dot{\mathcal{B}}_{\bm{\beta}n}^2(t) - \Omega^2\mathcal{B}_{\bm{\beta}n}^2(t)\right) + \sum_{\bm{\gamma}n}\int_0^\infty\frac{m_{\bm{\gamma}n}}{2}\left(\dot{\mathcal{C}}_{\bm{\gamma}n}^2(\nu,t) - \nu^2\mathcal{C}_{\bm{\gamma}n}^2(t)\right)\mathrm{d}\nu\\
% &\qquad + \sum_{\bm{\alpha}}\int_0^\infty\frac{\pi e^2}{4c^3}\left[\dot{\mathcal{A}}_{\bm{\alpha}}^2(\omega,t) - \omega^2\mathcal{A}_{\bm{\alpha}}^2(\omega,t)\right]\mathrm{d}\omega - \sum_{\bm{\beta}}\sum_{nn'}g_{\bm{\beta}nn'}^{(1)}\mathcal{B}_{\bm{\beta}n}(t)\mathcal{B}_{\bm{\beta}n'}(t)\\
% &\qquad - \sum_{\bm{\beta}n}F_{\bm{\beta}n}(t)\mathcal{B}_{\bm{\beta}n}(t) + \sum_{\bm{\beta}n}G_{\bm{\beta}n}(t)\dot{\mathcal{B}}_{\bm{\beta}n}(t) - \sum_{\bm{\beta}nn'}g_{\bm{\beta}nn'}^{(2)}\mathcal{B}_{\bm{\beta}n}(t)\mathcal{B}_{\bm{\beta}n'}(t)\\
...
% &\qquad - \sum_{\bm{\beta}n}\frac{m_{\bm{\beta}n}}{2}\left(\left[\frac{\mathcal{P}_{\bm{\beta}n}(t)}{m_{\bm{\beta}n}}\right]^2 - \Omega^2\mathcal{B}_{\bm{\beta}n}^2(t)\right) + \sum_{\bm{\beta}nn'}g_{\bm{\beta}nn'}\mathcal{B}_{\bm{\beta}n}(t)\mathcal{B}_{\bm{\beta}n'}(t)\\
...
% &\qquad - \sum_{\bm{\beta}n}\left(\frac{\mathcal{P}_{\bm{\beta}n}^2(t)}{2m_{\bm{\beta}n}} - \frac{1}{2}m_{\bm{\beta}n}\Omega^2\mathcal{B}_{\bm{\beta}n}^2(t)\right) + \sum_{\bm{\beta}nn'}g_{\bm{\beta}nn'}\mathcal{B}_{\bm{\beta}n}(t)\mathcal{B}_{\bm{\beta}n'}(t)\\
...
% &\qquad + \frac{1}{4\pi}\int\left[\nabla\Phi_f(\mathbf{r},t)\right]^2\;\mathrm{d}^3\mathbf{r} + \sum_{\bm{\alpha}}\int_0^\infty G_{\bm{\alpha}}[\{\mathbf{x}_{fi}(t)\},\omega]\mathcal{A}_{\bm{\alpha}}(\omega,t)\;\mathrm{d}\omega\\
% &= \sum_{\bm{\alpha}}\int_0^\infty\left(\frac{c^3}{\pi e^2\omega}\mathit{\Pi}_{\bm{\alpha}}^2(\omega,t) + \frac{\pi e^2\omega}{4c^3}\omega^2\mathcal{A}_{\bm{\alpha}}^2(\omega,t)\right)\mathrm{d}\omega + \sum_{\bm{\beta}n}\left(\frac{\mathcal{P}_{\bm{\beta}}^2(t)}{2m_{\bm{\beta}n}} + \frac{1}{2}m_{\bm{\beta}n}\left[\Omega^2 + \int_0^\infty\frac{2v_{\bm{\beta}n}^2(\nu)}{m_{\bm{\beta}n}^2}\;\mathrm{d}\nu\right]\mathcal{B}_{\bm{\beta}n}^2(t)\right)\\
...
% At this point, it is convenient to first identify that the coupling between the different modes of the system is strongly limited by symmetry. All coupling occurs between modes of common indices $p$, $\ell$, and $m$. Further, modes of magnetic type ($T = M$) only couple to other magnetic modes, due to the strict symmetry rules of $\tilde{g}_{\bm{\beta}\bm{\beta}'nn'}$. Defining the operator $\hat{H}$ as Eq. \eqref{eq:classicalHamiltonian} with the appropriate ``\;$\hat{}$\;'' symbols added, we can write
% \begin{equation}
% \hat{H} = \sum_{p\ell m}\left(\hat{H}_{p\ell m}^M + \hat{H}_{p\ell m}^{EL}\right),
% \end{equation}
% where terms of superscript $M$ only include magnetic modes and terms of superscript $EL$ include the coupled electric- and longitudinal-type modes. Further, to make each term more readable, we can drop the indices $p$, $\ell$, and $m$ in the following notation, as they are redundant. For example, we can let $\hat{H}_{p\ell m}^M\to\hat{H}_M$ and $\hat{H}_{p\ell m}^{EL}\to\hat{H}_{EL}$. Further, we can drop the type index labels $M$ from all of the terms in $\hat{H}_M$, as they too are redundant. In total, we have
% \begin{equation}
% \begin{split}
% \hat{H}_M &= \int_0^\infty\left(\frac{\hat{\mathit{\Pi}}^2(\omega,t)}{2m_0(\omega)} + \frac{1}{2}m_0(\omega)\omega^2\hat{\mathcal{A}}^2(\omega,t)\right)\mathrm{d}\omega + \sum_n\left(\frac{\hat{\mathcal{P}}_n^2(t)}{2m_n} + \frac{1}{2}m_n\Omega_0^2\hat{\mathcal{B}}_n^2(t)\right)\\
% &\qquad + \sum_n\int_0^\infty\left(\frac{\hat{\mathcal{Q}}_n^2(\nu,t)}{2m_n} + \frac{1}{2}m_n\nu^2\hat{\mathcal{C}}_n^2(\nu,t)\right)\mathrm{d}\nu + \sum_{nn'}\tilde{g}_{nn'}\hat{\mathcal{B}}_n(t)\hat{\mathcal{B}}_{n'}(t)\\
% &\qquad + \sum_n\int_0^\infty\frac{\lambda_n(\omega)}{m_0(\omega)}\hat{\mathit{\Pi}}(\omega,t)\hat{\mathcal{B}}_n(t)\;\mathrm{d}\omega - \sum_n\int_0^\infty\frac{\eta v(\nu)}{\mu}\hat{\mathcal{B}}_n(t)\hat{\mathcal{Q}}_n(\nu,t)\;\mathrm{d}\nu\\
% &\qquad + \sum_n\left[F_n(t) + \dot{G}_n(t)\right]\hat{\mathcal{B}}_n(t)
% \end{split}
% \end{equation}
% and
% \begin{equation}
% \begin{split}
% \hat{H}_{EL} &= \int_0^\infty\left(\frac{\hat{\mathit{\Pi}}_E^2(\omega,t)}{2m_0(\omega)} + \frac{1}{2}m_0(\omega)\omega^2\hat{\mathcal{A}}_E^2(\omega,t)\right)\mathrm{d}\omega + \sum_{T = E}^L\sum_n\left(\frac{\hat{\mathcal{P}}_{Tn}^2(t)}{2m_{Tn}} + \frac{1}{2}m_{Tn}\Omega_0^2\hat{\mathcal{B}}_{Tn}^2(t)\right)\\
% &\qquad + \sum_{T = E}^L\sum_n\int_0^\infty\left(\frac{\hat{\mathcal{Q}}_{Tn}^2(\nu,t)}{2m_{Tn}} + \frac{1}{2}m_{Tn}\nu^2\hat{\mathcal{C}}_{Tn}^2(\nu,t)\right)\mathrm{d}\nu + \sum_{T,T' = E}^L\sum_{nn'}\tilde{g}_{TT'nn'}\hat{\mathcal{B}}_{Tn}(t)\hat{\mathcal{B}}_{T'n'}(t)\\
% &\qquad + \sum_{T = E}^L\sum_n\int_0^\infty\frac{\lambda_{ETn}(\omega)}{m_0(\omega)}\hat{\mathit{\Pi}}_E(\omega,t)\hat{\mathcal{B}}_{Tn}(t)\;\mathrm{d}\omega - \sum_{T = E}^L\sum_n\int_0^\infty\frac{\eta v(\nu)}{\mu}\hat{\mathcal{B}}_{Tn}(t)\hat{\mathcal{Q}}_{Tn}(\nu,t)\;\mathrm{d}\nu\\
% &\qquad + \sum_{T = E}^L\sum_n\left[F_{Tn}(t) + \dot{G}_{Tn}(t)\right]\hat{\mathcal{B}}_{Tn}(t),
% \end{split}
% \end{equation}
% where $m_0(\omega) = \pi e^3\omega/2c^3$ is the photon effective mass.

% Before moving onto the usual ladder operator description of the system, it is convenient to analyze the parts of the above Hamiltonians that depend only on the coordinates and momenta of the matter resonances. The characteristic coupling constants of these terms are the constants $\tilde{g}_{nn'}$and $\tilde{g}_{TTnn'}$, which take the relatively simple forms 
% \begin{equation}
% \begin{split}
% \tilde{g}_{nn'} &= \int_0^\infty\frac{c^3}{\pi e^2\omega}\lambda_n(\omega)\lambda_{n'}(\omega)\;\mathrm{d}\omega = 4\pi^2\delta_{nn'}e^2a^3\eta^2j_{\ell - 1}^2(z_{\ell n}),\\
% \tilde{g}_{EEnn'} &= \int_0^\infty\frac{c^3}{\pi e^2\omega}\lambda_{En}(\omega)\lambda_{En'}(\omega)\;\mathrm{d}\omega = 4\pi^2\delta_{nn'}e^2a^3\eta^2j_{\ell - 1}^2(z_{\ell n}),\\
% \tilde{g}_{ELnn'} &= \int_0^\infty\frac{c^3}{\pi e^2\omega}\lambda_{En}(\omega)\lambda_{Ln'}(\omega)\;\mathrm{d}\omega = 0,\\
% \tilde{g}_{LEnn'} &= \int_0^\infty\frac{c^3}{\pi e^2\omega}\lambda_{Ln}(\omega)\lambda_{En'}(\omega)\;\mathrm{d}\omega = 0,\\
% \tilde{g}_{LLnn'}  &= g_{Lnn'} + \int_0^\infty\frac{c^3}{\pi e^2\omega}\lambda_{Ln}(\omega)\lambda_{Ln'}(\omega)\;\mathrm{d}\omega
% % \\
% % &= 4\pi^2\delta_{nn'}e^2a^3\eta^2j_\ell^2(w_{\ell n})\left(1 - \frac{\ell(\ell + 1)}{w_{\ell n}^2}\right) - 8\pi^2e^2a^3\eta^2\frac{\ell(\ell + 1)}{2\ell + 1}\frac{j_\ell(w_{\ell n})j_\ell(w_{\ell n'})}{w_{\ell n}w_{\ell n'}}\\
% % &\qquad + 8\pi^2e^2a^3\eta^2\frac{\ell(\ell + 1)}{2\ell + 1}\frac{j_\ell(w_{\ell n})j_\ell(w_{\ell n'})}{w_{\ell n}w_{\ell n'}}\\
% % &
% = 4\pi^2\delta_{nn'}e^2a^3\eta^2j_\ell^2(w_{\ell n})\left(1 - \frac{\ell(\ell + 1)}{w_{\ell n}^2}\right),
% \end{split}
% \end{equation}
% as can be seen be combining the results for $g_{\bm{\beta}nn'}$ above with the derivations of Appendix \ref{app:matterPhotonCoupling}. Importantly, these coupling constants do not allow for energy to pass between any two modes of different indices, such that they only serve to modify the resonance frequencies of each mode via a ``self-coupling'' interaction.
...
% Beginning with the magnetic Hamiltonians, we have
% \begin{equation}
% \begin{split}
% \hat{H}_M^\mathrm{mat} &= \sum_{n}\left(\frac{\hat{\mathcal{P}}_{n}^2(t)}{2m_n} + \frac{1}{2}m_{n}\Omega_0^2\hat{\mathcal{B}}_{n}(t)\right) + \sum_{nn'}\tilde{g}_{nn'}\hat{\mathcal{B}}_{n}(t)\hat{\mathcal{B}}_{n'}(t)\\
% &= \frac{1}{2}\hat{\bm{\mathcal{P}}}^\top(t)\mathbf{M}^{-1}\hat{\bm{\mathcal{P}}}(t) + \frac{1}{2}\hat{\bm{\mathcal{B}}}(t)^\top\mathbf{M}^{\frac{1}{2}}\bm{\Omega}\mathbf{M}^{\frac{1}{2}}\hat{\bm{\mathcal{B}}}(t),
% \end{split}
% \end{equation}
% where $\hat{\bm{\mathcal{P}}}(t) = \left(\hat{\mathcal{P}}_1(t)\;\;\hat{\mathcal{P}}_2(t)\;\;\cdots\right)^\top$ and $\hat{\bm{\mathcal{B}}}(t) = \left(\hat{\mathcal{B}}_1(t)\;\;\hat{\mathcal{B}}_2(t)\;\;\cdots\right)^\top$ are operator-valued vectors of the mode momentum and coordinates, respectively, and
% \begin{equation}
...
% \bm{\Omega} = 
% \begin{pmatrix}
% \Omega_0^2 + \frac{2\tilde{g}_{11}}{m_1} & \frac{2\tilde{g}_{12}}{\sqrt{m_1m_2}} & \cdots\\
% \frac{2\tilde{g}_{21}}{\sqrt{m_1m_2}} & \Omega_0^2 + \frac{2\tilde{g}_{22}}{m_2} &\\
% \vdots & & \ddots
% \end{pmatrix}
% \end{equation}
% are the (diagonal) mass matrix and characteristic matrix of the system, respectively. First, we can expand the characteristic matrix numerically as 
% \begin{equation}
% \bm{\Omega} = \mathbf{V}\bm{\Lambda}\mathbf{V}^{-1},
% \end{equation}
% where
% \begin{equation}
% \bm{\Lambda} = 
...
% \end{pmatrix}
% \end{equation}
% are the diagonal matrix of eigenvalues $\Omega_i^2$ and orthogonal matrix of (unitless, normalized) eigenvectors $\mathbf{v}_i$, respectively, of $\bm{\Omega}$. This allows us to define renormalized coordinates
% \begin{equation}
% \hat{\tilde{\mathcal{B}}}_i(t) = \sum_{n = 1}^\infty v_{in}\sqrt{m_n}\hat{\mathcal{B}}_n(t)
% \end{equation}
% such that $\hat{\tilde{\bm{\mathcal{B}}}}(t) = \mathbf{V}^\top\mathbf{M}^\frac{1}{2}\hat{\bm{\mathcal{B}}}(t)$ and $\hat{\bm{\mathcal{B}}}^\top(t)\mathbf{M}^\frac{1}{2}\mathbf{V}\bm{\Lambda}\mathbf{V}\mathbf{M}^\frac{1}{2}\hat{\bm{\mathcal{B}}}(t) = \hat{\tilde{\bm{\mathcal{B}}}}^\top(t)\bm{\Lambda}\hat{\tilde{\bm{\mathcal{B}}}}(t)$. Next, we can define renormalized momenta as
% \begin{equation}
% \hat{\tilde{\mathcal{P}}}_i = \sum_{n=1}^\infty\frac{v_{in}}{\sqrt{m_n}}\hat{\mathcal{P}}_n(t),
% \end{equation}
% such that $\hat{\tilde{\bm{\mathcal{P}}}}(t) = \mathbf{V}^\top\mathbf{M}^{-\frac{1}{2}}\hat{\bm{\mathcal{P}}}(t)$ and $\hat{\bm{\mathcal{P}}}^\top(t)\mathbf{M}^{-1}\hat{\bm{\mathcal{P}}}(t) = \hat{\bm{\mathcal{P}}}^\top(t)\mathbf{M}^{-\frac{1}{2}}\mathbf{V}\mathbf{V}^\top\mathbf{M}^{-\frac{1}{2}}\hat{\bm{\mathcal{P}}}(t) = \hat{\tilde{\bm{\mathcal{P}}}}^\top(t)\hat{\tilde{\bm{\mathcal{P}}}}(t)$.
% Finally, we have
% \begin{equation}
% \hat{H}_M^\mathrm{mat} = \frac{1}{2}\sum_i\left(\hat{\tilde{\mathcal{P}}}_i^2(t) + \Omega_i^2\hat{\tilde{\mathcal{B}}}_i^2(t)\right)
% \end{equation}
% and
% \begin{equation}
% \begin{split}
% \left[\hat{\tilde{\mathcal{B}}}_i(t),\hat{\tilde{\mathcal{P}}}_j(t)\right] &= \left[\sum_nv_{in}\sqrt{m_n}\hat{\mathcal{B}}_n(t),\sum_{n'}v_{jn'}\frac{1}{\sqrt{m_{n'}}}\hat{\mathcal{P}}_{n'}(t)\right]\\
% % &= \sum_{nn'}v_{in}v_{jn'}\sqrt{\frac{m_n}{m_{n'}}}\left[\hat{\mathcal{B}}_n(t),\hat{\mathcal{P}}_{n'}(t)\right]\\
% % &= \sum_{nn'}v_{in}v_{jn'}\sqrt{\frac{m_n}{m_{n'}}}\mathrm{i\hbar}\delta_{nn'}\\
% % &= \sum_{n}v_{in}v_{jn}\mathrm{i}\hbar\\
% &= \mathrm{i}\hbar\delta_{ij},
% \end{split}
% \end{equation}
% such that we have diagonalized $\hat{H}_M^\mathrm{mat}$ while maintaining the canonical conjugacy of our coordinate-momentum pairs.


% This process can straightforwardly be repeated for the electric-longitudinal Hamiltonians,
% \begin{equation}
% \begin{split}
% \hat{H}_{EL}^\mathrm{mat} &= \sum_{T\neq M}\sum_n\left(\frac{\hat{\mathcal{P}}_{Tn}^2(t)}{2m_{Tn}} + \frac{1}{2}m_{Tn}\Omega_0^2\hat{\mathcal{B}}_{Tn}(t)\right) + \sum_{T,T'\neq M}\sum_{nn'}\tilde{g}_{TT'nn'}\hat{\mathcal{B}}_{Tn}(t)\hat{\mathcal{B}}_{T'n'}(t)\\
% &= \frac{1}{2}\sum_i\left(\hat{\tilde{\mathcal{P}}}_i^{\prime2} + \Omega_i^{\prime2}\hat{\tilde{\mathcal{B}}}_i^{\prime2}(t)\right),
% \end{split}
% \end{equation}
% where
% \begin{equation}
...
% \bm{\Omega}' = 
% \begin{pmatrix}
% \Omega_0^2 + \frac{2\tilde{g}_{EE11}}{m_{E1}} & \frac{2\tilde{g}_{EE12}}{\sqrt{m_{E1}m_{E2}}} & \cdots & \frac{2\tilde{g}_{EL11}}{\sqrt{m_{E1}m_{L1}}} & \frac{2\tilde{g}_{EL12}}{\sqrt{m_{E1}m_{L2}}} & \cdots\\
% \frac{2\tilde{g}_{EE21}}{\sqrt{m_{E2}m_{E1}}} & \Omega_0^2 + \frac{2\tilde{g}_{EE22}}{m_{E2}} & \cdots & \frac{2\tilde{g}_{EL21}}{\sqrt{m_{E2}m_{L1}}} & \frac{2\tilde{g}_{EL22}}{\sqrt{m_{E2}m_{L2}}} &\\
% \vdots & & \ddots & & \vdots &\\
% \frac{2\tilde{g}_{LE11}}{\sqrt{m_{L1}m_{E 1}}} & \frac{2\tilde{g}_{LE12}}{\sqrt{m_{L1}m_{E2}}} & \cdots & \Omega_0^2 + \frac{2\tilde{g}_{LL11}}{m_{L1}} & \frac{2\tilde{g}_{LL12}}{\sqrt{m_{L1}m_{L2}}} & \\
% \frac{2\tilde{g}_{LE21}}{\sqrt{m_{L2}m_{E1}}} & \frac{2\tilde{g}_{LE22}}{\sqrt{m_{L2}m_{E2}}} & \cdots & \frac{2\tilde{g}_{LL21}}{\sqrt{m_{L2}m_{L1}}} & \Omega_0^2 + \frac{2\tilde{g}_{LL22}}{m_{L2}} & \\
% \vdots & & & & & \ddots
% \end{pmatrix}
% \end{equation}
% are the corresponding mass and characteristic matrices, and 
% \begin{equation}
% \bm{\Omega}' = \mathbf{V}'\bm{\Lambda}'\mathbf{V}^{\prime-1}
% \end{equation}
% the expansion of the characteristic matrix with
% \begin{equation}
% \bm{\Lambda}' =
% \begin{pmatrix}
% \Omega_1^{\prime2} & 0 & \cdots\\
% 0 & \Omega_2^{\prime2} & \\
% \vdots & & \ddots
% \end{pmatrix} 
% \end{equation}
...
% \end{pmatrix}
% \end{equation}
% the electric-longitudinal matrices of eigenvalues and eigenvectors. With these, the rescaled momenta and coordinates
% \begin{equation}
% \begin{split}
% \hat{\tilde{\mathcal{P}}}_i'(t) &= \sum_nn_{in}'\left[\Theta(N - n)\frac{\hat{\mathcal{P}}_{En}(t)}{\sqrt{m_{Tn}}} + \Theta(n - N)\frac{\hat{\mathcal{P}}_{Ln}(t)}{\sqrt{m_{Ln}}}\right],\\
% \hat{\tilde{\mathcal{B}}}_i'(t) &= \sum_nv_{in}'\left[\Theta(N - n)\sqrt{m_{En}}\hat{\mathcal{B}}_{En}(t) + \Theta(n - N)\sqrt{m_{Ln}}\hat{\mathcal{B}}_{Ln}(t)\right]
% \end{split}
% \end{equation}
% can be defined with the assumption that $N$ electric and $N$ longitudinal modes are in the system. The physical picture is, of course, recovered in the limit $N\to\infty$. Finally, it is straightforward to show
% \begin{equation}
% \left[\hat{\tilde{\mathcal{B}}}_i(t),\hat{\tilde{\mathcal{P}}}_j(t)\right] = \mathrm{i}\hbar\delta_{ij}.
% \end{equation}

% In order to rewrite our total Hamiltonians in the rescaled basis, we need to know how to carry out the inverse transformations $\hat{\tilde{\mathcal{B}}}_i(t)\to\hat{\mathcal{B}}_i(t)$, etc. Because the matrices of eigenvectors $\mathbf{V}$ and $\mathbf{V}'$ are unitary, we have two sets of orthogonality relations:
% \begin{equation}
% \begin{split}
% \sum_nv_{in}v_{jn} &= \sum_nv_{in}'v_{jn}' = \delta_{ij},\\
% \sum_iv_{in}v_{im} &= \sum_iv_{in}'v_{im}' = \delta_{nm}.
% \end{split}
% \end{equation}
% Therefore, we can see that
% \begin{equation}
% \begin{split}
% \sum_iv_{in}\hat{\tilde{\mathcal{B}}}_i(t) 
% &= \sum_{i,n'}v_{in}v_{in'}\sqrt{m_n'}\hat{\mathcal{B}}_{n'}(t)\\
% &= \sum_{n'}\delta_{nn'}\sqrt{m_{n'}}\hat{\mathcal{B}}_{n'}(t)\\
% &= \sqrt{m_n}\hat{\mathcal{B}}_n(t),\\
% \implies \hat{\mathcal{B}}_n(t) &= \frac{1}{\sqrt{m_n}}\sum_iv_{in}\hat{\tilde{\mathcal{B}}}_i(t),
% \end{split}
% \end{equation}
% such that
% \begin{equation}
% \begin{split}
% \hat{\mathcal{P}}_{n} &= \sqrt{m_n}\sum_iv_{in}\hat{\tilde{\mathcal{P}}}(t),\\
% \hat{\mathcal{B}}_{Tn}'(t) &= \frac{1}{\sqrt{m_{Tn}}}\sum_i\left(v_{in}'\delta_{TE} + v_{i,n+N}\delta_{TL}\right)\hat{\tilde{\mathcal{B}}}_i'(t),\\
% \hat{\mathcal{P}}_{Tn}'(t) &= \sqrt{m_{Tn}}\sum_i\left(v_{in}'\delta_{TE} + v_{i,n+N}\delta_{TL}\right)\hat{\tilde{\mathcal{P}}}_i'(t).
% \end{split}
% \end{equation}
...
% \begin{split}
% \hat{H}_M 
% % &= \int_0^\infty\left(\frac{\hat{\mathit{\Pi}}^2(\omega,t)}{2m_0(\omega)} + \frac{1}{2}m_0(\omega)\omega^2\hat{\mathcal{A}}^2(\omega,t)\right)\mathrm{d}\omega + \frac{1}{2}\sum_i\left(\hat{\tilde{\mathcal{P}}}_i^2(t)+ \Omega_i^2\hat{\tilde{\mathcal{B}}}_i^2(t)\right)\\
% % &\qquad + \sum_n\int_0^\infty\left(\frac{\hat{\mathcal{Q}}_n^2(\nu,t)}{2m_n} + \frac{1}{2}m_n\nu^2\hat{\mathcal{C}}_n^2(\nu,t)\right)\mathrm{d}\nu\\
% % &\qquad + \sum_n\int_0^\infty\frac{\lambda_n(\omega)}{m_0(\omega)}\hat{\mathit{\Pi}}(\omega,t)\frac{1}{\sqrt{m_n}}\sum_iv_{in}\hat{\tilde{\mathcal{B}}}_i(t)\;\mathrm{d}\omega - \sum_n\int_0^\infty\frac{\eta v(\nu)}{\mu}\frac{1}{\sqrt{m_n}}\sum_iv_{in}\hat{\tilde{\mathcal{B}}}_i(t)\hat{\mathcal{Q}}_n(\nu,t)\;\mathrm{d}\nu\\
% % &\qquad + \sum_n\left[F_n(t) + \dot{G}_n(t)\right]\frac{1}{\sqrt{m_n}}\sum_iv_{in}\hat{\tilde{\mathcal{B}}}_i(t)\\
% &= \int_0^\infty\left(\frac{\hat{\mathit{\Pi}}^2(\omega,t)}{2m_0(\omega)} + \frac{1}{2}m_0(\omega)\omega^2\hat{\mathcal{A}}^2(\omega,t)\right)\mathrm{d}\omega + \frac{1}{2}\sum_i\left(\hat{\tilde{\mathcal{P}}}_i^2(t)+ \Omega_i^2\hat{\tilde{\mathcal{B}}}_i^2(t)\right)\\
% &\qquad + \sum_n\int_0^\infty\left(\frac{\hat{\mathcal{Q}}_n^2(\nu,t)}{2m_n} + \frac{1}{2}m_n\nu^2\hat{\mathcal{C}}_n^2(\nu,t)\right)\mathrm{d}\nu + \sum_{in}\int_0^\infty\frac{\lambda_n(\omega)v_{in}}{m_0(\omega)\sqrt{m_n}}\hat{\mathit{\Pi}}(\omega,t)\hat{\tilde{\mathcal{B}}}_i(t)\;\mathrm{d}\omega\\
% &\qquad - \sum_{in}\int_0^\infty\frac{\eta v(\nu)v_{in}}{\mu\sqrt{m_n}}\hat{\tilde{\mathcal{B}}}_i(t)\hat{\mathcal{Q}}_n(\nu,t)\;\mathrm{d}\nu + \sum_{in}\frac{v_{in}}{\sqrt{m_n}}\left[F_n(t) + \dot{G}_n(t)\right]\hat{\tilde{\mathcal{B}}}_i(t)
% \end{split}
% \end{equation}
% and
% \begin{equation}
% \begin{split}
% H_{EL}^\mathrm{mat} 
% % &= \int_0^\infty\left(\frac{\hat{\mathit{\Pi}}_E^2(\omega,t)}{2m_0(\omega)} + \frac{1}{2}m_0(\omega)\omega^2\hat{\mathcal{A}}_E^2(\omega,t)\right)\mathrm{d}\omega +\frac{1}{2}\sum_i\left(\hat{\tilde{\mathcal{P}}}_i^{\prime2}(t) + \Omega_i^{\prime2}\hat{\tilde{\mathcal{B}}}_i^{\prime2}(t)\right)\\
% % &\qquad + \sum_{T = E}^L\sum_n\int_0^\infty\left(\frac{\hat{\mathcal{Q}}_{Tn}^2(\nu,t)}{2m_{Tn}} + \frac{1}{2}m_{Tn}\nu^2\hat{\mathcal{C}}_{Tn}^2(\nu,t)\right)\mathrm{d}\nu\\
% % &\qquad + \sum_{T = E}^L\sum_n\int_0^\infty\frac{\lambda_{ETn}(\omega)}{m_0(\omega)}\hat{\mathit{\Pi}}_E(\omega,t)\frac{1}{\sqrt{m_{Tn}}}\sum_i(v_{in}'\delta_{TE} + v_{i,n + N}\delta_{TL})\hat{\tilde{\mathcal{B}}}_i'(t)\;\mathrm{d}\omega\\
% % &\qquad - \sum_{T = E}^L\sum_n\int_0^\infty\frac{\eta v(\nu)}{\mu}\frac{1}{\sqrt{m_{Tn}}}\sum_i(v_{in}'\delta_{TE} + v_{i,n + N}'\delta_{TL})\hat{\tilde{\mathcal{B}}}_i'(t)\hat{\mathcal{Q}}_{Tn}(\nu,t)\;\mathrm{d}\nu\\
% % &\qquad + \sum_{T = E}^L\sum_n\left[F_{Tn}(t) + \dot{G}_{Tn}(t)\right]\frac{1}{\sqrt{m_{Tn}}}\sum_i(v_{in}'\delta_{TE} + v_{i,n + N}\delta_{TL})\hat{\tilde{\mathcal{B}}}_i'(t)\\
% &= \int_0^\infty\left(\frac{\hat{\mathit{\Pi}}_E^2(\omega,t)}{2m_0(\omega)} + \frac{1}{2}m_0(\omega)\omega^2\hat{\mathcal{A}}_E^2(\omega,t)\right)\mathrm{d}\omega +\frac{1}{2}\sum_i\left(\hat{\tilde{\mathcal{P}}}_i^{\prime2}(t) + \Omega_i^{\prime2}\hat{\tilde{\mathcal{B}}}_i^{\prime2}(t)\right)\\
% &\qquad + \sum_{T = E}^L\sum_n\int_0^\infty\left(\frac{\hat{\mathcal{Q}}_{Tn}^2(\nu,t)}{2m_{Tn}} + \frac{1}{2}m_{Tn}\nu^2\hat{\mathcal{C}}_{Tn}^2(\nu,t)\right)\mathrm{d}\nu\\
% &\qquad + \sum_{T\neq M}\sum_{in}\int_0^\infty\frac{\lambda_{ETn}(\omega)}{m_0(\omega)\sqrt{m_{Tn}}}\left(v_{in}'\delta_{TE} + v_{i,n+N}'\delta_{TL}\right)\hat{\mathit{\Pi}}_E(\omega,t)\hat{\tilde{\mathcal{B}}}_i'(t)\;\mathrm{d}\omega\\
% &\qquad - \sum_{T\neq M}\sum_{in}\int_0^\infty\frac{\eta v(\nu)}{\mu\sqrt{m_{Tn}}}\left(v_{in}'\delta_{TE} + v_{i,n+N}'\delta_{TL}\right)\hat{\tilde{\mathcal{B}}}_i'(t)\hat{\mathcal{Q}}_{Tn}(\nu,t)\;\mathrm{d}\nu\\
% &\qquad + \sum_{T\neq M}\sum_{in}\frac{1}{\sqrt{m_{Tn}}}\left[F_{Tn}(t) + \dot{G}_{Tn}(t)\right]\left(v_{in}'\delta_{TE} + v_{i,n+N}'\delta_{TL}\right)\hat{\tilde{\mathcal{B}}}_i'(t).
% \end{split}
% \end{equation}

% At this point, we want to move into a ladder-operator formalism. Restoring the full set of mode indices for a moment such that
% \begin{equation}
% \begin{split}
% \hat{\tilde{\mathcal{B}}}_i(t) &\to \hat{\tilde{\mathcal{B}}}_{p\ell mi}(t),\\
% \hat{\tilde{\mathcal{B}}}_i'(t) &\to \hat{\tilde{\mathcal{B}}}_{p\ell mi}'(t),\\
% \hat{\tilde{\mathcal{P}}}_i(t) &\to \hat{\tilde{\mathcal{P}}}_{p\ell mi}(t),\\
% \hat{\tilde{\mathcal{P}}}_i'(t) &\to \hat{\tilde{\mathcal{P}}}_{p\ell mi}'(t),\\
% \end{split}
% \end{equation}
...
% \begin{split}
% \hat{a}_{\bm{\alpha}}(\omega,t) &= \sqrt{\frac{m_0(\omega)}{2\hbar\omega}}\left[-\mathrm{i}\omega\hat{\mathcal{A}}_{\bm{\alpha}}(\omega,t) + \frac{1}{m_0(\omega)}\hat{\mathit{\Pi}}_{\bm{\alpha}}(\omega,t)\right],\\
% \hat{b}_{p\ell mi}(t) &= \sqrt{\frac{1}{2\hbar\Omega_{p\ell mi}}}\left[\Omega_{p\ell mi}\hat{\tilde{\mathcal{B}}}_{p\ell mi}(t) + \mathrm{i}\hat{\tilde{\mathcal{P}}}_{p\ell mi}(t)\right],\\
% \hat{b}_{p\ell mi}'(t) &= \sqrt{\frac{1}{2\hbar\Omega_{p\ell mi}'}}\left[\Omega_{p\ell mi}'\hat{\tilde{\mathcal{B}}}_{p\ell mi}'(t) + \mathrm{i}\hat{\tilde{\mathcal{P}}}_{p\ell mi}'(t)\right],\\
% \hat{c}_{\bm{\gamma}n}(\nu,t) &= \sqrt{\frac{m_{\bm{\gamma}n}}{2\hbar\nu}}\left[-\mathrm{i}\nu\hat{\mathcal{C}}_{\bm{\gamma}n}(\nu,t) + \frac{1}{m_{\bm{\gamma}n}}\hat{\mathcal{Q}}_{\bm{\gamma}n}(\nu,t)\right],
% \end{split}
% \end{equation}
...
% \begin{split}
% \left[\hat{a}_{\bm{\alpha}}(\omega,t),\hat{a}_{\bm{\alpha}'}^\dagger(\omega',t)\right] &= \delta_{\bm{\alpha}\bm{\alpha}'}\delta(\omega - \omega'),\\
% \left[\hat{b}_{p\ell mi}(t),\hat{b}_{p'\ell'm'j}^\dagger(t)\right] &= \delta_{pp'}\delta_{\ell\ell'}\delta_{mm'}\delta_{ij},\\
% \left[\hat{b}_{p\ell mi}'(t),\hat{b}_{p'\ell'm'j}^{\prime\dagger}(t)\right] &= \delta_{pp'}\delta_{\ell\ell'}\delta_{mm'}\delta_{ij},\\
% \left[\hat{c}_{\bm{\gamma}n}(\nu,t),\hat{c}_{\bm{\gamma}'n'}^\dagger(\nu',t)\right] &= \delta_{\bm{\gamma}\bm{\gamma}'}\delta_{nn'}\delta(\nu - \nu'),
% \end{split}
% \end{equation}
% and
...
% \begin{split}
% \left[\hat{a}_{\bm{\alpha}}(\omega,t),\hat{a}_{\bm{\alpha}'}(\omega',t)\right] &= \left[\hat{a}_{\bm{\alpha}}^\dagger(\omega,t),\hat{a}_{\bm{\alpha}'}^\dagger(\omega',t)\right] = 0,\\
% \left[\hat{b}_{p\ell mi}(t),\hat{b}_{p'\ell'm'j}(t)\right] &= \left[\hat{b}_{p\ell mi}^\dagger(t),\hat{b}_{p'\ell'm'j}^\dagger(t)\right] = 0,\\
% \left[\hat{b}_{p\ell mi}'(t),\hat{b}_{p'\ell'm'j}'(t)\right] &= \left[\hat{b}_{p\ell mi}^{\prime\dagger}(t),\hat{b}_{p'\ell'm'j}^{\prime\dagger}(t)\right] = 0,\\
% \left[\hat{c}_{\bm{\gamma}n}(\nu,t),\hat{c}_{\bm{\gamma}'n'}(\nu',t)\right] &= \left[\hat{c}_{\bm{\gamma}n}^\dagger(\nu,t),\hat{c}_{\bm{\gamma}'n'}^\dagger(\nu',t)\right] = 0.
% \end{split}
% \end{equation}
...
% \hat{\mathcal{A}}_{\bm{\alpha}}(\omega,t) &= \mathrm{i}\sqrt{\frac{\hbar}{2\omega m_0(\omega)}}\left[\hat{a}_{\bm{\alpha}}(\omega,t) - \hat{a}_{\bm{\alpha}}^\dagger(\omega,t)\right],\\
% \hat{\mathit{\Pi}}_{\bm{\alpha}}(\omega,t) &= \sqrt{\frac{m_0(\omega)\hbar\omega}{2}}\left[\hat{a}_{\bm{\alpha}}(\omega,t) + \hat{a}_{\bm{\alpha}}^\dagger(\omega,t)\right],\\[0.5em]
% \hat{\tilde{\mathcal{B}}}_{p\ell mi}(t) &= \sqrt{\frac{\hbar}{2\Omega_{p\ell mi}}}\left[\hat{b}_{p\ell mi}(t) + \hat{b}_{p\ell mi}^\dagger(t)\right],\\
% \hat{\tilde{\mathcal{P}}}_{p\ell mi}(t) &= -\mathrm{i}\sqrt{\frac{\hbar\Omega_{p\ell mi}}{2}}\left[\hat{b}_{p\ell mi}(t) - \hat{b}_{p\ell mi}^\dagger(t)\right],\\[0.5em]
% \hat{\tilde{\mathcal{B}}}_{p\ell mi}'(t) &= \sqrt{\frac{\hbar}{2\Omega_{p\ell mi}'}}\left[\hat{b}_{p\ell mi}'(t) + \hat{b}_{p\ell mi}^{\prime\dagger}(t)\right],\\
% \hat{\tilde{\mathcal{P}}}_{p\ell mi}'(t) &= -\mathrm{i}\sqrt{\frac{\hbar\Omega_{p\ell mi}'}{2}}\left[\hat{b}_{p\ell mi}'(t) - \hat{b}_{p\ell mi}^{\prime\dagger}(t)\right],\\[0.5em]
% \hat{\mathcal{C}}_{\bm{\gamma}n}(\nu,t) &= \mathrm{i}\sqrt{\frac{\hbar}{2\nu m_{\bm{\gamma}n}}}\left[\hat{c}_{\bm{\gamma}n}(\nu,t) - \hat{c}_{\bm{\gamma}n}^\dagger(\nu,t)\right],\\
% \hat{\mathcal{Q}}_{\bm{\gamma}n}(\nu,t) &= \sqrt{\frac{m_{\bm{\gamma}n}\hbar\nu}{2}}\left[\hat{c}_{\bm{\gamma}n}(\nu,t) + \hat{c}_{\bm{\gamma}n}^\dagger(\nu,t)\right].
% \end{split}
% \end{equation}
% Dropping the superfluous indices once again, this allows us to write down the Hamiltonian operators as
% \begin{equation}
% \begin{split}
% \hat{H}_M 
% % &= \int_0^\infty\left(\frac{\hat{\mathit{\Pi}}^2(\omega,t)}{2m_0(\omega)} + \frac{1}{2}m_0(\omega)\omega^2\hat{\mathcal{A}}^2(\omega,t)\right)\mathrm{d}\omega + \frac{1}{2}\sum_i\left(\hat{\tilde{\mathcal{P}}}_i^2(t)+ \Omega_i^2\hat{\tilde{\mathcal{B}}}_i^2(t)\right)\\
% % &\qquad + \sum_n\int_0^\infty\left(\frac{\hat{\mathcal{Q}}_n^2(\nu,t)}{2m_n} + \frac{1}{2}m_n\nu^2\hat{\mathcal{C}}_n^2(\nu,t)\right)\mathrm{d}\nu + \sum_{in}\int_0^\infty\frac{\lambda_n(\omega)v_{in}}{m_0(\omega)\sqrt{m_n}}\hat{\mathit{\Pi}}(\omega,t)\hat{\tilde{\mathcal{B}}}_i(t)\;\mathrm{d}\omega\\
% % &\qquad - \sum_{in}\int_0^\infty\frac{\eta v(\nu)v_{in}}{\mu\sqrt{m_n}}\hat{\tilde{\mathcal{B}}}_i(t)\hat{\mathcal{Q}}_n(\nu,t)\;\mathrm{d}\nu + \sum_{in}\frac{v_{in}}{\sqrt{m_n}}\left[F_n(t) + \dot{G}_n(t)\right]\hat{\tilde{\mathcal{B}}}_i(t)\\
% % &= \frac{1}{2}\int_0^\infty\left(\frac{1}{m_0(\omega)}\frac{m_0(\omega)\hbar\omega}{2}\left[\hat{a}(\omega,t) + \hat{a}^\dagger(\omega,t)\right]^2 - m_0(\omega)\omega^2\frac{\hbar}{2\omega m_0(\omega)}\left[\hat{a}(\omega,t) - \hat{a}^\dagger(\omega,t)\right]^2\right)\mathrm{d}\omega\\
% % &\qquad + \frac{1}{2}\sum_i\left(-\frac{\hbar\Omega_i}{2}\left[\hat{b}_i(t) - \hat{b}_i^\dagger(t)\right]^2 + \Omega_i^2\frac{\hbar}{2\Omega_i}\left[\hat{b}_i(t) + \hat{b}_i^\dagger(t)\right]^2\right)\\
% % &\qquad + \frac{1}{2}\sum_n\int_0^\infty\left(\frac{1}{m_n}\frac{m_n\hbar\nu}{2}\left[\hat{c}_n(t) + \hat{c}_n^\dagger(t)\right]^2 - m_n\nu^2\frac{\hbar}{2\nu m_n}\left[\hat{c}_n(\nu,t) - \hat{c}_n^\dagger(\nu,t)\right]^2\right)\mathrm{d}\nu\\
% % &\qquad + \sum_{in}\int_0^\infty\frac{\lambda_n(\omega)v_{in}}{m_0(\omega)\sqrt{m_n}}\sqrt{\frac{m_0(\omega)\hbar\omega}{2}}\sqrt{\frac{\hbar}{2\Omega_i}}\left[\hat{a}(\omega,t) + \hat{a}^\dagger(\omega,t)\right]\left[\hat{b}_i(t) + \hat{b}_i^\dagger(t)\right]\mathrm{d}\omega\\
% % &\qquad - \sum_{in}\int_0^\infty\frac{\eta v(\nu)v_{in}}{\mu\sqrt{m_n}}\sqrt{\frac{\hbar}{2\Omega_i}}\sqrt{\frac{m_n\hbar\nu}{2}}\left[\hat{b}_i(t) + \hat{b}_i^\dagger(t)\right]\left[\hat{c}_n(t) + \hat{c}_n^\dagger(t)\right]\mathrm{d}\nu\\
% % &\qquad + \sum_{in}\frac{v_{in}}{\sqrt{m_n}}\left[F_n(t) + \dot{G}_n(t)\right]\sqrt{\frac{\hbar}{2\Omega_i}}\left[\hat{b}_i(t) + \hat{b}_i^\dagger(t)\right]\\
% % &= \frac{1}{4}\int_0^\infty\hbar\omega\left[2\hat{a}(\omega,t)\hat{a}^\dagger(\omega,t) + 2\hat{a}^\dagger(\omega,t)\hat{a}(\omega,t)\right]\mathrm{d}\omega + \frac{1}{4}\sum_i\hbar\Omega_i\left[2\hat{b}_i(t)\hat{b}_i^\dagger(t) + 2\hat{b}_i^\dagger(t)\hat{b}_i(t)\right]\\
% % &\qquad + \frac{1}{4}\sum_n\int_0^\infty\hbar\nu\left[2\hat{c}_n(\nu,t)\hat{c}_n^\dagger(\nu,t) + 2\hat{c}_n^\dagger(\nu,t)\hat{c}_n(\nu,t)\right]\mathrm{d}\nu\\
% % &\qquad + \sum_{in}\int_0^\infty\frac{\hbar\lambda_n(\omega)v_{in}}{2\sqrt{m_0(\omega)m_n}}\sqrt{\frac{\omega}{\Omega_i}}\left[\hat{a}(\omega,t) + \hat{a}^\dagger(\omega,t)\right]\left[\hat{b}_i(t) + \hat{b}_i^\dagger(t)\right]\mathrm{d}\omega\\
% % &\qquad - \sum_{in}\int_0^\infty\frac{\hbar\eta v(\nu)v_{in}}{2\mu}\sqrt{\frac{\nu}{\Omega_i}}\left[\hat{b}_i(t) + \hat{b}_i^\dagger(t)\right]\left[\hat{c}_n(\nu,t) + \hat{c}_n^\dagger(\nu,t)\right]\mathrm{d}\nu\\
% % &\qquad + \sum_{in}v_{in}\sqrt{\frac{\hbar}{2\Omega_im_n}}\left[F_n(t) + \dot{G}_n(t)\right]\left[\hat{b}_i(t) + \hat{b}_i^\dagger(t)\right]\\
% &= \int_0^\infty\hbar\omega\hat{a}^\dagger(\omega,t)\hat{a}(\omega,t)\;\mathrm{d}\omega + \sum_{i}\hbar\Omega_i\hat{b}_i^\dagger(t)\hat{b}_i(t) + \sum_n\int_0^\infty\hbar\nu\hat{c}_n^\dagger(\nu,t)\hat{c}_n(\nu,t)\;\mathrm{d}\nu\\
% &\qquad + \sum_i\int_0^\infty\hbar\Lambda_i(\omega)\left[\hat{a}(\omega,t) + \hat{a}^\dagger(\omega,t)\right]\left[\hat{b}_i(t) + \hat{b}_i^\dagger(t)\right]\mathrm{d}\omega\\
% &\qquad + \sum_{in}\int_0^\infty\hbar V_{in}(\nu)\left[\hat{b}_i(t) + \hat{b}_i^\dagger(t)\right]\left[\hat{c}_n(\nu,t) + \hat{c}_n^\dagger(\nu,t)\right]\mathrm{d}\nu\\
% &\qquad + \sum_i\hbar J_i(t)\left[\hat{b}_i(t) + \hat{b}_i^\dagger(t)\right]
% \end{split}
% \end{equation}
% and
% \begin{equation}
...
% % &\qquad - \sum_{T\neq M}\sum_{in}\int_0^\infty\frac{\eta v(\nu)}{\mu\sqrt{m_{Tn}}}\left(v_{in}'\delta_{TE} + v_{i,n+N}'\delta_{TL}\right)\hat{\tilde{\mathcal{B}}}_i'(t)\hat{\mathcal{Q}}_{Tn}(\nu,t)\;\mathrm{d}\nu\\
% % &\qquad + \sum_{T\neq M}\sum_{in}\frac{1}{\sqrt{m_{Tn}}}\left[F_{Tn}(t) + \dot{G}_{Tn}(t)\right]\left(v_{in}'\delta_{TE} + v_{i,n+N}'\delta_{TL}\right)\hat{\tilde{\mathcal{B}}}_i'(t)\\
% % &= \int_0^\infty\hbar\omega\hat{a}_E^\dagger(\omega,t)\hat{a}_E(\omega,t)\;\mathrm{d}\omega + \sum_i\hbar\Omega_i'\hat{b}_i^{\prime\dagger}(t)\hat{b}_i'(t) + \sum_{T\neq M}\sum_n\int_0^\infty\hbar\nu\hat{c}_{Tn}^\dagger(\nu,t)\hat{c}_{Tn}(\nu,t)\;\mathrm{d}\nu\\
% % &\qquad + \sum_{T\neq M}\sum_{in}\int_0^\infty\frac{\lambda_{ETn}(\omega)}{m_0(\omega)\sqrt{m_{Tn}}}\left(v_{in}'\delta_{TE} + v_{i,n + N}'\delta_{TL}\right)\\
% % &\qquad\qquad\times\sqrt{\frac{m_0(\omega)\hbar\omega}{2}}\sqrt{\frac{\hbar}{2\Omega'_i}}\left[\hat{a}_E(\omega,t) + \hat{a}_E^\dagger(\omega,t)\right]\left[\hat{b}_i'(t) + \hat{b}_i^{\prime\dagger}(t)\right]\mathrm{d}\omega\\
% % &\qquad - \sum_{T\neq M}\sum_{in}\int_0^\infty\frac{\eta v(\nu)}{\mu\sqrt{m_{Tn}}}\left(v_{in}'\delta_{TE} + v_{i,n + N}'\delta_{TL}\right)\\
% % &\qquad\qquad\times\sqrt{\frac{m_{Tn}\hbar\nu}{2}}\sqrt{\frac{\hbar}{2\Omega_i'}}\left[\hat{b}_i'(t) + \hat{b}_i^{\prime\dagger}(t)\right]\left[\hat{c}_{Tn}(\nu,t) + \hat{c}_{Tn}^\dagger(\nu,t)\right]\mathrm{d}\nu\\
% % &\qquad + \sum_{T\neq M}\sum_{in}\frac{1}{\sqrt{m_{Tn}}}\left[F_{Tn}(t) + \dot{G}_{Tn}(t)\right]\left(v_{in}'\delta_{TE} + v_{i,n+N}'\delta_{TL}\right)\sqrt{\frac{\hbar}{2\Omega_i'}}\left[\hat{b}_i'(t) + \hat{b}_i^{\prime\dagger}(t)\right]\\
% &= \int_0^\infty\hbar\omega\hat{a}_E^\dagger(\omega,t)\hat{a}_E(\omega,t)\;\mathrm{d}\omega + \sum_i\hbar\Omega_i'\hat{b}_i^{\prime\dagger}(t)\hat{b}_i'(t) + \sum_{T\neq M}\sum_n\int_0^\infty\hbar\nu\hat{c}_{Tn}^\dagger(\nu,t)\hat{c}_{Tn}(\nu,t)\;\mathrm{d}\nu\\
% &\qquad + \sum_{T\neq M}\sum_i\int_0^\infty\hbar\Lambda_i'(\omega)\left[\hat{a}_E(\omega,t) + \hat{a}_E^\dagger(\omega,t)\right]\left[\hat{b}_i'(t) + \hat{b}_i^{\prime\dagger}(t)\right]\mathrm{d}\omega\\
% &\qquad + \sum_{T\neq M}\sum_{in}\hbar V_{Tin}'(\nu)\left[\hat{b}_i'(t) + \hat{b}_i^{\prime\dagger}(t)\right]\left[\hat{c}_{Tn}(\nu,t) + \hat{c}_{Tn}^\dagger(\nu,t)\right]\mathrm{d}\nu\\
% &\qquad + \sum_i\hbar J_i'(t)\left[\hat{b}_i'(t) + \hat{b}_i^{\prime\dagger}(t)\right]
% \end{split}
% \end{equation}
% where we have defined the coefficients
% \begin{equation}
% \begin{split}
% \Lambda_i(\omega) &= \sum_n\frac{v_{in}}{2}\sqrt{\frac{\omega}{m_0(\omega)m_n\Omega_i}}\lambda_n(\omega),\\
% V_{in}(\nu) &= -\frac{v_{in}}{2}\frac{\eta}{\mu}\sqrt{\frac{\nu}{\Omega_i}}v(\nu),\\
% J_i(t) &= \sum_nv_{in}\sqrt{\frac{1}{2\hbar\Omega_im_n}}\left[F_n(t) + \dot{G}_n(t)\right],\\[1.0em]
% \Lambda_i'(\omega) &= \sum_{T\neq M}\sum_n\frac{1}{2}\left(v_{in}'\delta_{TE} + v_{i,n + N}'\delta_{TL}\right)\sqrt{\frac{\omega}{m_0(\omega)m_{Tn}\Omega_i'}}\lambda_{ETn}(\omega),\\
% V_{in}'(\nu) &= -\frac{1}{2}\left(v_{in}'\delta_{TE} + v_{i,n + N}'\delta_{TL}\right)\frac{\eta}{\mu}\sqrt{\frac{\nu}{\Omega_i'}}v(\nu),\\
% J_i'(t) &= \sum_{T\neq M}\sum_n\left(v_{in}'\delta_{TE} + v_{i,n + N}'\delta_{TL}\right)\sqrt{\frac{1}{2\hbar\Omega_i'm_{Tn}}}\left[F_{Tn}(t) + \dot{G}_{Tn}(t)\right].
% \end{split}
% \end{equation}
% Further, we have exploited the identities
% \begin{equation}
% \begin{split}
% \hat{a}_{\bm{\alpha}}(\omega,t)\hat{a}_{\bm{\alpha}}^\dagger(\omega,t) &= \hat{a}_{\bm{\alpha}}^\dagger(\omega,t)\hat{a}_{\bm{\alpha}}(\omega,t) + 1,\\
% \hat{b}_i(t)\hat{b}_i^\dagger(t) &= \hat{b}_i^\dagger(t)\hat{b}_i(t) + 1,\\
% \hat{b}_i'(t)\hat{b}_i^{\prime\dagger}(t) &= \hat{b}_i^{\prime\dagger}(t)\hat{b}_i'(t) + 1,\\
% \hat{c}_{\bm{\gamma}n}(\nu,t)\hat{c}_{\bm{\gamma}n}^\dagger(\nu,t) &= \hat{c}_{\bm{\gamma}n}^\dagger(\nu,t)\hat{c}_{\bm{\gamma}n}(\nu,t) + 1,\\
% \end{split}
% \end{equation}
% and dropped all constant terms in our Hamiltonians.
...
% % &\qquad + \sum_{\bm{\beta}n}\left(\frac{1}{2m_{\bm{\beta}n}}(-1)\frac{m_{\bm{\beta}n}\hbar\Omega_0}{2}\left[\hat{b}_{\bm{\beta}n}(t) - \hat{b}_{\bm{\beta}n}^\dagger(t)\right]^2 + \frac{m_{\bm{\beta}n}\Omega_0^2}{2}\frac{\hbar}{2\Omega_0m_{\bm{\beta}n}}\left[\hat{b}_{\bm{\beta}n}(t) + \hat{b}_{\bm{\beta}n}(t)\right]^2\right)\\
% % &\qquad + \sum_{\bm{\gamma}n}\int_0^\infty\left(\frac{1}{2m_{\bm{\gamma}n}}\frac{m_{\bm{\gamma}n}\hbar\nu}{2}\left[\hat{c}_{\bm{\gamma}n}(\nu,t) + \hat{c}_{\bm{\gamma}n}^\dagger(\nu,t)\right]^2 + \frac{m_{\bm{\gamma}n}\nu^2}{2}(-1)\frac{\hbar}{2\nu m_{\bm{\gamma}n}}\left[\hat{c}_{\bm{\gamma}n}(\nu,t) - \hat{c}_{\bm{\gamma}n}^\dagger(\nu,t)\right]^2\right)\mathrm{d}\nu\\
% % &\qquad + \sum_{\bm{\beta}\bm{\beta}'}\sum_{nn'}\tilde{g}_{\bm{\beta}\bm{\beta}'nn'}\frac{\hbar}{2\Omega_0\sqrt{m_{\bm{\beta}n}m_{\bm{\beta}'n'}}}\left[\hat{b}_{\bm{\beta}n}(t) + \hat{b}_{\bm{\beta}n}^\dagger(t)\right]\left[\hat{b}_{\bm{\beta}'n'}(t) + \hat{b}_{\bm{\beta}'n'}^\dagger(t)\right]\\
% % &\qquad + \sum_{\bm{\alpha}\bm{\beta}n}\int_0^\infty\frac{2c^3}{\pi e^2\omega}\lambda_{\bm{\alpha}\bm{\beta}n}(\omega)\sqrt{\frac{\pi e^2\hbar\omega^2}{4c^3}}\left[\hat{a}_{\bm{\alpha}}(\omega,t) + \hat{a}_{\bm{\alpha}}^\dagger(\omega,t)\right]\sqrt{\frac{\hbar}{2\Omega_0m_{\bm{\beta}n}}}\left[\hat{b}_{\bm{\beta}n}(t) + \hat{b}_{\bm{\beta}n}^\dagger(t)\right]\mathrm{d}\omega\\
% % &\qquad - \sum_{\bm{\beta}n}\int_0^\infty\frac{\eta v(\nu)}{\mu}\sqrt{\frac{\hbar}{2\Omega_0m_{\bm{\beta}n}}}\left[\hat{b}_{\bm{\beta}n}(t) + \hat{b}_{\bm{\beta}n}^\dagger(t)\right]\sqrt{\frac{m_{\bm{\beta}n}\hbar\nu}{2}}\left[\hat{c}_{\bm{\beta}n}(\nu,t) + \hat{c}_{\bm{\beta}n}^\dagger(\nu,t)\right]\mathrm{d}\nu\\
% % &\qquad + \sum_{\bm{\beta}n}\left[F_{\bm{\beta}n}(t) + \dot{G}_{\bm{\beta}n}(t)\right]\sqrt{\frac{\hbar}{2\Omega_0m_{\bm{\beta}n}}}\left[\hat{b}_{\bm{\beta}n}(t) + \hat{b}_{\bm{\beta}n}^\dagger(t)\right]\\
...
% % &\qquad + \sum_{\bm{\beta}n}\left(-\frac{\hbar\Omega_0}{4}\left[\hat{b}_{\bm{\beta}n}(t) - \hat{b}_{\bm{\beta}n}^\dagger(t)\right]^2 + \frac{\hbar\Omega_0}{4}\left[\hat{b}_{\bm{\beta}n}(t) + \hat{b}_{\bm{\beta}n}^\dagger(t)\right]^2\right)\\
% % &\qquad + \sum_{\bm{\gamma}n}\int_0^\infty\left(\frac{\hbar\nu}{4}\left[\hat{c}_{\bm{\gamma}n}(\nu,t) + \hat{c}_{\bm{\gamma}n}^\dagger(\nu,t)\right]^2 - \frac{\hbar\nu}{4}\left[\hat{c}_{\bm{\gamma}n}(\nu,t) - \hat{c}_{\bm{\gamma}n}^\dagger(\nu,t)\right]^2\right)\mathrm{d}\nu\\
% % &\qquad + \sum_{\bm{\beta}\bm{\beta}'}\sum_{nn'}\tilde{g}_{\bm{\beta}\bm{\beta}'nn'}\frac{\hbar}{2\Omega_0\sqrt{m_{\bm{\beta}n}m_{\bm{\beta}'n'}}}\left[\hat{b}_{\bm{\beta}n}(t) + \hat{b}_{\bm{\beta}n}^\dagger(t)\right]\left[\hat{b}_{\bm{\beta}'n'}(t) + \hat{b}_{\bm{\beta}'n'}^\dagger(t)\right]\\
% % &\qquad + \sum_{\bm{\alpha}\bm{\beta}n}\int_0^\infty\sqrt{\frac{c^3\hbar^2}{2\pi e^2\Omega_0m_{\bm{\beta}n}}}\lambda_{\bm{\alpha}\bm{\beta}n}(\omega)\left[\hat{a}_{\bm{\alpha}}(\omega,t) + \hat{a}_{\bm{\alpha}}^\dagger(\omega,t)\right]\left[\hat{b}_{\bm{\beta}n}(t) + \hat{b}_{\bm{\beta}n}^\dagger(t)\right]\mathrm{d}\omega\\
% % &\qquad - \sum_{\bm{\beta}n}\int_0^\infty \sqrt{\frac{\hbar^2\eta^2\nu}{4\Omega_0\mu^2}}v(\nu)\left[\hat{b}_{\bm{\beta}n}(t) + \hat{b}_{\bm{\beta}n}^\dagger(t)\right]\left[\hat{c}_{\bm{\beta}n}(\nu,t) + \hat{c}_{\bm{\beta}n}^\dagger(\nu,t)\right]\mathrm{d}\nu\\
% % &\qquad + \sum_{\bm{\beta}n}\hbar\sqrt{\frac{1}{2\hbar\Omega_0m_{\bm{\beta}n}}}\left[F_{\bm{\beta}n}(t) + \dot{G}_{\bm{\beta}n}(t)\right]\left[\hat{b}_{\bm{\beta}n}(t) + \hat{b}_{\bm{\beta}n}^\dagger(t)\right]\\
...
% % &\qquad + \sum_{\bm{\beta}n}\frac{\hbar\Omega_0}{4}\left[2\hat{b}_{\bm{\beta}n}^\dagger(t)\hat{b}_{\bm{\beta}n}(t) + 2\hat{b}_{\bm{\beta}n}(t)\hat{b}_{\bm{\beta}n}^\dagger(t)\right]\\
...
% % &\qquad + \sum_n\int_0^\infty\Lambda_n(\omega)\left[a(\omega,t) + \hat{a}^\dagger(\omega,t)\right]\left[\sum_iu_{i,2n}\hat{B}_i^\dagger(t) + \sum_iu_{i,2n}\hat{B}_i(t)\right]\mathrm{d}\omega\\
% % &\qquad + \sum_n\int_0^\infty\hbar V(\nu)\left[\sum_iu_{i,2n}\hat{B}_i^\dagger(t) + \sum_iu_{i,2n}\hat{B}_i(t)\right]\left[\hat{c}_n(\nu,t) + \hat{c}_n^\dagger(\nu,t)\right]\mathrm{d}\nu\\
% % &\qquad + \sum_n\hbar J_n(t)\left[\sum_iu_{i,2n}\hat{B}_i^\dagger(t) + \sum_iu_{i,2n}\hat{B}_i(t)\right]\\
% &= \int_0^\infty\hbar\omega\hat{a}^\dagger(\omega,t)\hat{a}(\omega,t)\;\mathrm{d}\omega + \sum_i\hbar\Omega_i\hat{B}_i^\dagger(t)\hat{B}_i(t) + \sum_n\int_0^\infty\hbar\nu\hat{c}_n^\dagger(\nu,t)\hat{c}_n(\nu,t)\;\mathrm{d}\nu\\
...
% % &\qquad + \sum_{n = 1}^{2N}\int_0^\infty\hbar\Lambda_{EEn}(\omega)\left[\hat{a}_E(\omega,t) + \hat{a}_E^\dagger(\omega,t)\right]\sum_iu'_{i,2n}\Theta_{N - n}\left[\hat{B}'_i(t) + \hat{B}_i^{\prime\dagger}(t)\right]\;\mathrm{d}\omega\\
% % &\qquad + \sum_{n = 1}^{2N}\int_0^\infty\hbar\Lambda_{ELn}(\omega)\left[\hat{a}_E(\omega,t) + \hat{a}_E^\dagger(\omega,t)\right]\sum_iu'_{i,2n}\Theta_{n - N - 1}\left[\hat{B}'_i(t) + \hat{B}_i^{\prime\dagger}(t)\right]\mathrm{d}\omega\\
% % &\qquad + \sum_{n = 1}^{2N}\int_0^\infty\hbar V(\nu)\sum_iu'_{i,2n}\Theta_{N - n}\left[\hat{B}'_i(t) + \hat{B}_i^{\prime\dagger}(t)\right]\left[\hat{c}_{En}(\nu,t) + \hat{c}_{En}^\dagger(\nu,t)\right]\mathrm{d}\nu\\
% % &\qquad + \sum_{n = 1}^{2N}\int_0^\infty\hbar V(\nu)\sum_iu'_{i,2n}\Theta_{n - N - 1}\left[\hat{B}'_i(t) + \hat{B}_i^{\prime\dagger}(t)\right]\left[\hat{c}_{L,n - N}(\nu,t) + \hat{c}_{L,n - N}^\dagger(\nu,t)\right]\mathrm{d}\nu\\
% % &\qquad + \sum_{n = 1}^{2N}\hbar J_{En}(t)\sum_iu_{i,2n}'\Theta_{N-n}\left[\hat{B}_i'(t) + \hat{B}_i^{\prime\dagger}(t)\right]\\
% % &\qquad + \sum_{n = 1}^{2N}\hbar J_{Ln}(t)\sum_iu_{i,2n}'\Theta_{n - N - 1}\left[\hat{B}_i'(t) + \hat{B}_i^{\prime\dagger}(t)\right]\\
% % &= \int_0^\infty\hbar\omega\hat{a}_E^\dagger(\omega,t)\hat{a}_E(\omega,t)\;\mathrm{d}\omega + \sum_i\hbar\Omega_i'\hat{B}_i^{\prime\dagger}(t)\hat{B}'_i(t) + \sum_{S}\sum_{n = 1}^N\int_0^\infty\hbar\nu\hat{c}_{Sn}^\dagger(\nu,t)\hat{c}_{Sn}(\nu,t)\;\mathrm{d}\nu\\
...
% % &\qquad + \sum_i\hbar \tilde{J}_{Ei}(t)\left[\hat{B}_i'(t) + \hat{B}_i^{\prime\dagger}(t)\right] + \sum_i\hbar \tilde{J}_{Li}(t)\left[\hat{B}_i'(t) + \hat{B}_i^{\prime\dagger}(t)\right]\\
% &= \int_0^\infty\hbar\omega\hat{a}_E^\dagger(\omega,t)\hat{a}_E(\omega,t)\;\mathrm{d}\omega + \sum_i\hbar\Omega_i'\hat{B}_i^{\prime\dagger}(t)\hat{B}'_i(t) + \sum_{S}\sum_{n = 1}^N\int_0^\infty\hbar\nu\hat{c}_{Sn}^\dagger(\nu,t)\hat{c}_{Sn}(\nu,t)\;\mathrm{d}\nu\\
% &\qquad + \sum_i\int_0^\infty\hbar\tilde{\Lambda}_{Ei}(\omega)\left[\hat{a}_E(\omega,t) + \hat{a}_E^\dagger(\omega,t)\right]\left[\hat{B}'_i(t) + \hat{B}_i^{\prime\dagger}(t)\right]\mathrm{d}\omega\\
...
% % &= \sum_{n = 1}^{2N}u'_{i,2n}\left(\Lambda_{EEn}(\omega)\Theta_{N - n} + \Lambda_{ELn}(\omega)\Theta_{n - N - 1}\right)\\
...
% % &= \sum_\kappa\int_0^\infty\frac{4\Omega_i^2\Sigma_i^2(\omega)}{|\omega^2 - \Omega_i^2Z_i(\omega)|^2}\left(\left[\frac{\omega + \Omega_i}{2\Omega_i}\alpha_\kappa(\omega)p_{\kappa i}^*(\omega) - \frac{\omega - \Omega_i}{2\Omega_i}\alpha_\kappa^*(\omega)p_{\kappa i}^*(\omega)\right]\hat{C}_\kappa(\omega,t)\right.\\
% % &\qquad\left. + \left[-\frac{\omega - \Omega_i}{2\Omega_i}\alpha_\kappa(\omega)p_{\kappa i}(\omega) + \frac{\omega + \Omega_i}{2\Omega_i}\alpha_\kappa^*(\omega)p_{\kappa i}(\omega)\right]\hat{C}_\kappa^\dagger(\omega,t)\right)\mathrm{d}\omega\\
% % &= \sum_\kappa\int_0^\infty\frac{2\Omega_i\Sigma_i^2(\omega)}{|\omega^2 - \Omega_i^2Z_i(\omega)|}\left(\left[(\omega + \Omega_i)\alpha_\kappa(\omega) - (\omega - \Omega_i)\alpha_\kappa^*(\omega)\right]p_{\kappa i}^*(\omega)\hat{C}_\kappa(\omega,t)\right.\\
% % &\qquad + \left.\left[-(\omega - \Omega_i)\alpha_\kappa(\omega) + (\omega + \Omega_i)\alpha_\kappa^*(\omega)\right]p_{\kappa i}(\omega)\hat{C}_\kappa^\dagger(\omega,t)\right)\mathrm{d}\omega\\
...
% % &= \sum_\kappa\int_0^\infty\frac{4\Omega_i^{\prime2}\Sigma_i^{\prime2}(\omega)}{|\omega^2 - \Omega_i^{\prime2}Z_i'(\omega)|^2}\left(\left[\frac{\omega + \Omega_i'}{2\Omega_i'}\alpha_\kappa'(\omega)x_{\kappa i}^*(\omega) - \frac{\omega - \Omega_i'}{2\Omega_i'}\alpha_\kappa^{\prime*}(\omega)x_{\kappa i}^*(\omega)\right]\hat{C}_\kappa'(\omega,t)\right.\\
% % &\qquad\left. + \left[-\frac{\omega - \Omega_i'}{2\Omega_i'}\alpha_\kappa'(\omega)x_{\kappa i}(\omega) + \frac{\omega + \Omega_i'}{2\Omega_i'}\alpha_\kappa^{\prime*}(\omega)x_{\kappa i}(\omega)\right]\hat{C}_\kappa^{\prime\dagger}(\omega,t)\right)\mathrm{d}\omega\\
...
% \begin{split}
% P_{\kappa i}(\omega) 
% % &= \frac{2\Omega_i\Sigma_i^2(\omega)}{|\omega^2 - \Omega_i^2Z_i(\omega)|^2}[(\omega + \Omega_i)\alpha_\kappa^*(\omega) - (\omega - \Omega_i)\alpha_\kappa(\omega)]p_{\kappa i}(\omega)\\
% % &= \frac{2\Omega_i\Sigma_i^2(\omega)}{|\omega^2 - \Omega_i^2Z_i(\omega)|^2}2\Omega_i\alpha_\kappa(\omega)p_{\kappa i}(\omega)\\
% &= \frac{4\Omega_i^2\Sigma_i^2(\omega)}{|\omega^2 - \Omega_i^2Z_i(\omega)|^2}\alpha_\kappa(\omega)p_{\kappa i}(\omega),\\
% X_{\kappa i}(\omega) 
% % &= \frac{2\Omega_i'\Sigma_i^{\prime2}(\omega)}{|\omega^2 - \Omega_i^{\prime2}Z_i'(\omega)|^2}[(\omega + \Omega_i')\alpha_\kappa^{\prime*}(\omega) - (\omega - \Omega_i')\alpha_\kappa'(\omega)]x_{\kappa i}(\omega)\\
% % &= \frac{2\Omega_i'\Sigma_i^{\prime2}(\omega)}{|\omega^2 - \Omega_i^{\prime2}Z_i'(\omega)|^2}2\Omega_i'\alpha_\kappa'(\omega)x_{\kappa i}(\omega)\\
% &= \frac{4\Omega_i^{\prime2}\Sigma_i^{\prime2}(\omega)}{|\omega^2 - \Omega_i^{\prime2}Z_i'(\omega)|^2}\alpha_\kappa'(\omega)x_{\kappa i}(\omega).
% \end{split}
% \end{equation}
% Therefore,
% \begin{equation}\label{eq:diagonalHamiltonian}
% \begin{split}
% \hat{H}_M(t) &= \sum_\kappa\int_0^\infty\hbar\omega\hat{C}_\kappa^\dagger(\omega,t)\hat{C}_\kappa(\omega,t)\;\mathrm{d}\omega + \sum_{\kappa i}\int_0^\infty\hbar\tilde{J}_i(t)\left(P_{\kappa i}^*(\omega)\hat{C}_\kappa(\omega,t) + P_{\kappa i}(\omega)\hat{C}_\kappa^\dagger(\omega,t)\right)\mathrm{d}\omega,\\
% \hat{H}_{EL}(t) &= \sum_\kappa\int_0^\infty\hbar\omega\hat{C}_\kappa^{\prime\dagger}(\omega,t)\hat{C}_\kappa'(\omega,t)\;\mathrm{d}\omega + \sum_{\kappa i}\int_0^\infty\hbar\tilde{J}_i'(t)\left(X_{\kappa i}^*(\omega)\hat{C}_\kappa'(\omega,t) + X_{\kappa i}(\omega)\hat{C}_\kappa^{\prime\dagger}(\omega,t)\right)\mathrm{d}\omega.,
% \end{split}
% \end{equation}
% where we have let $\tilde{J}_i'(t) = \sum_S\tilde{J}_{Si}(t)$.
...
\input{operatorFanoDiagonalizationManyModes}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \input{polarizationWaveEquation}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Algebra for Calculating Integrals of Matter-Photon Coupling Coefficients
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{matterPhotonCouplingAlgebra}
...
% \begin{equation}
% \Phi(\mathbf{r},t) = \Phi_f(\mathbf{r},t) + \Phi(\mathbf{r},t)
% \end{equation}
